...
arguments:
  - name: target
    description: "Host group to deploy to (proxmox, tailscale, plex, kaz, arr, truenas, uptime-kuma, caddy, pi-hole)"
    required: true
---
...
1. Validate that `{{target}}` is one of: proxmox, tailscale, plex, kaz, arr, truenas, uptime-kuma, caddy, pi-hole
